...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="/">Zaunita<span>.</span></a></h1>
...
<main id="main" data-aos="fade-up">
    ...
    <section id="services" class="services">
        <div class="container m-10" data-aos="fade-up">

            <div class="section-title">
                <h2>Reservar</h2>
                <h3>Confira mais detalhes de nossos <span>livros</span></h3>
            ...
            <div class="row">
                <div class="card m-4 p-4" style="width: 30rem;">
                    ...
                    <div class="section-title">
                        <h2><a href="reserve?id=<?php echo $book['id'] ?>"> <i
                                    class="bi bi-journal-richtext m-2"></i>Reservar</a></h2>
                    </div>
                </div>
                <div class="card m-4 p-4" style="width: 30rem;">
                    <div class="card-body">
